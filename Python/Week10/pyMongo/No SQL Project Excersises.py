...
m4 = {"_id": document_id4}
document_id5 = ObjectId('65a90974f775bbb6d3dfca1d')
m5 = {"_id": document_id5}
...
print(f"Smallest _id: {min_lesson_id}, Largest _id: {max_lesson_id}")
...
print(f"Smallest _id: {min_members_id}, Largest _id: {max_members_id}")
...
# Find the average CourseID from all lessons in lesson table
